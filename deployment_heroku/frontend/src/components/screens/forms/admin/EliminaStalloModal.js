...
export default function EliminaStalloModal(props) {
    ...
    return (
        <Modal
            {...props}
            size="m"
            aria-labelledby="eliminaStalloModal"
            centered
            animation={false}>
            <Modal.Header>
                <Modal.Title className="t-bold" id="eliminaStalloModal">
                    Elimina Stallo
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {state.error.show ?
                    ...
                    : <Row className="gy-4" >
                        <Col >
                            <h3 className="t-bold text-center h5">Sei sicuro di voler eliminare questo stallo?</h3>
                        </Col>
