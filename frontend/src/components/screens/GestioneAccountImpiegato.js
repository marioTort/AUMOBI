...
// Schermata profilo
export default function GestioneAccountImpiegato() {
            ...
            <Row className="g-0 h-100 align-items-center">             
                <Col xs={{ span: 10, offset: 1 }} lg={{ span: 4, offset: 1 }} className="ms-lg-auto mt-5 mt-lg-0">
                    ...
                    <Col xs={{ span: 10 }} lg={{ span: 4 }} >
                        <Card className="border-5 shadow h-100">
                        ...
                        <div className=" py-3">
                            ...
                            <Button className="my-3" variant="outline-primary py-2" onClick={() => setModals({ ...modals, cambiaCellulareModal: true })}>
                                Modifica cellulare
                            </Button>
                            <Button className="my-3" variant="outline-primary py-2" onClick={() => setModals({ ...modals, cambiaEmailModal: true })}>
                                Modifica email
                            </Button>
