...
// Custom Components
import RicercaPrenotazioneAutista from './forms/impiegato/RicercaPrenotazioneAutista';

// Schermata profilo
export default function VisualizzaPrenotazioniAutista() {
    
    return (
        <React.Fragment>
        <Container fluid className="mt-4">
        <h2 className="t-bold pb-3 mt-5"><center>Visualizza prenotazioni</center></h2>
            <RicercaPrenotazioneAutista/>
