...
export default function IniziaPrenotazioneModal(props) {
    ...
    async function iniziaPrenotazione(event) {
        ...
        var config = {
            method: 'put',
            url: '/api/prenotazione/iniziaprenotazione',
            headers: {
    ...
    return (
        <Modal
            {...props}
            size="m"
            aria-labelledby="iniziaPrenotazioneModal"
            centered
            animation={false}>
            <Modal.Header>
                <Modal.Title className="t-bold" id="iniziaPrenotazioneModal">
                    Inizia Prenotazione
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {state.error.show ?
                    ...
                    : <Row className="gy-4" >
                        <Col >
                            <h3 className="t-bold text-center h5">Scannerizza il QR-code oppure inserisci il numero della prenotazione per iniziare la prenotazione.</h3>
                        </Col>
                        <QRCode/>
                        ...
                        <div className="buttonsGroup mx-auto">
                            ...
                            <Button variant="outline-primary" onClick={iniziaPrenotazione}>Prosegui</Button>
                        </div>
                    </Row>
                }
            </Modal.Body>
