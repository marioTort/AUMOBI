...
export default function EliminaImpiegatoModal(props) {
    ...
    return (
        <Modal
            {...props}
            size="m"
            aria-labelledby="eliminaImpiegatoModal"
            centered
            animation={false}>
            <Modal.Header>
                <Modal.Title className="t-bold" id="eliminaImpiegatoModal">
                    Elimina Impiegato
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {state.error.show ?
                    ...
                    : <Row className="gy-4" >
                        <Col >
                            <h3 className="t-bold text-center h5">Sei sicuro di voler eliminare questo impiegato?</h3>
                        </Col>
