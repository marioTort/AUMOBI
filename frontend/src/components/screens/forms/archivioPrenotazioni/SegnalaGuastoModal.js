...
export default function SegnalaGuastoModal(props) {
    ...
    return (
        <Modal
            {...props}
            size="m"
            aria-labelledby="segnalaGuastoModal"
            centered
            animation={false}>
            <Modal.Header>
                <Modal.Title className="t-bold" id="segnalaGuastoModal">
                    Segnala guasto
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                    ...
                    : <Row className="gy-4" >
                        <Col xs={{ span: 12 }} lg={{ span: 10, offset: 1 }}>
                                <Form.Group controlId="luogoConsegna">
                                    <Form.Label>Luogo del guasto</Form.Label>
                                    <Form.Control type="text" placeholder="Inserisci il luogo in cui hai riscontrato il guasto" required />
                                </Form.Group>
                            </Col>
                        <div className="buttonsGroup mx-auto">
                            <Button variant="outline-secondary" onClick={props.onHide}>Indietro</Button>
                            <Button spinner={state.submit} variant="outline-danger" onClick={onClick}>Invia segnalazione</Button>
                        </div>
                    </Row>
                }
            </Modal.Body>
